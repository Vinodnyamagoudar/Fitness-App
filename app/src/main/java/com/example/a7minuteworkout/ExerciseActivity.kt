...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setRestProgressBar() {
        ...
        restTimer = object : CountDownTimer(restTimerDuration*1000, 1000) {             //change made here from 10k to 3k
    ...
    private fun setExerciseProgressBar() {
        ...
        exerciseTimer = object : CountDownTimer(exerciseTimerDuration*1000, 1000) {         //change made here from 30k to 3k
            override fun onTick(millisUntilFinished: Long) {
                exerciseProgress++
    ...
    override fun onInit(status: Int) {
        if(status == TextToSpeech.SUCCESS){
            ...
            Log.e("TTS","Intitiallization failed")
